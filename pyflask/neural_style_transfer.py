...
def main(refer_img_path, target_img_path):
    ...
    # image 경로
    style_reference_image_path = 'flask_deep/static/images/nst_get/' + \
    ...
    # 	gtape.gradient(loss, combination_image)
    ...
    save_img(fname, img)  # save_img(name, img)
