...
def nst_post():
    if request.method == 'POST':
        ...
        # Neural Style Transfer
        transfer_img = neural_style_transfer.main(
            refer_img_path, user_img_path)
...
#     return render_template('./templates/object_detection_get.html')
...
#             detected_img_path = './static/images/' + \
#                 str(detected_img.split('/')[-1])

#         # video file
#         elif user_img_type in ['avi', 'AVI', 'mp4', 'MP4', 'MPEG', 'mkv', 'MKV']:
#             print('Type is Video')

#     return render_template('./templates/object_detection_post.html', detected_img=detected_img_path)
